...
/***/ function(module, exports, __webpack_require__) {
	...
	var actions = __webpack_require__(4);
	// var Navbar = require('../components/navbar');
	var IntegrationBrowser = __webpack_require__(128);
	var lodash = __webpack_require__(5);
	var Select = __webpack_require__(3);
	var ServiceMultiSelect = __webpack_require__(70);
	var InputList = __webpack_require__(298);
	...
	module.exports = React.createClass({
	  ...
	  checkDiscountCode: function checkDiscountCode() {
	    var self = this;
	    actions.verifyDiscountCode(self.state.integrationRequest.discountCode).then(function (result) {
	      if (result.discount) {
	  ...
	  handleSubmit: function handleSubmit() {
	    return actions.createIntegrationRequest(this.state.integrationRequest).then(function (result) {
	      return actions.goto('/integration_request/' + result.integrationRequest.id);
	    });
	  },
	  render: function render() {
	    var consultantLevelOptions = [{ label: 'Bronze Tier - $25/hour', value: 'bronze' }, { label: 'Silver Tier - $50/hour', value: 'silver' }, { label: 'Gold Tier - $75/hour', value: 'gold' }, { label: 'Platinum Tier - $100/hour', value: 'platinum' }, { label: 'Diamond Tier - $125/hour', value: 'diamond' }];
	    var consultantRates = {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        'h1',
	        null,
	        'Get an Instant Integration Quote'
	      ),
	      React.createElement(
	        'div',
	        null,
	      ...
	      React.createElement(
	        'h2',
	        null,
	        'Which apps do you need integrated?'
	      ),
	      React.createElement(ServiceMultiSelect, {
	      ...
	      React.createElement(
	        'p',
	        { className: 'pt-label' },
	        'List any apps we need to connect that aren\'t already on NativeSync.',
	      ...
	      React.createElement(
	        'h2',
	        null,
	        'Let us know how the integration should work, step-by-step.'
	      ),
	      React.createElement(InputList, {
	      ...
	      React.createElement(
	        'h2',
	        null,
	        'Choose a consultant level that fits your budget'
	      ),
	      React.createElement(Select, {
	      ...
	      this.state.integrationRequest.consultantLevel == 'bronze' && React.createElement(
	        'ul',
	        null,
	        React.createElement(
	          'li',
	          null,
	          'At least 1 year of professional developer experience.'
	        ),
	        React.createElement(
	          'li',
	          null,
	          'Supervised by a NativeSync consulting manager'
	        ),
	        React.createElement(
	          'li',
	          null,
	          'Passed the introductory NativeSync training program'
	        )
	      ),
	      this.state.integrationRequest.consultantLevel == 'silver' && React.createElement(
	        'ul',
	        null,
	        React.createElement(
	          'li',
	        ...
	        React.createElement(
	          'li',
	          null,
	          'Passed the Intermediate Nativesync Consulting program'
	        ),
	        React.createElement(
	          'li',
	          null,
	          'Has built at least 5 NativeSync Integrations'
	        ),
	        React.createElement(
	          'li',
	          null,
	          'Has contributed at least 10 NativeSync actions'
	        )
	      ),
	      this.state.integrationRequest.consultantLevel == 'gold' && React.createElement(
	        'ul',
	        null,
	        React.createElement(
	          'li',
	          null,
	          'At least 3 years of professional developer experience.'
	        ),
	        React.createElement(
	          'li',
	          null,
	        ...
	        React.createElement(
	          'li',
	          null,
	          'Has built at least 20 NativeSync Integrations'
	        ),
	        React.createElement(
	          'li',
	          null,
	          'Has contributed at least 40 NativeSync actions'
	        )
	      ),
	      this.state.integrationRequest.consultantLevel == 'platinum' && React.createElement(
	        'ul',
	        null,
	        React.createElement(
	          'li',
	          null,
	          'At least 5 years of professional developer experience.'
	        ),
	        React.createElement(
	          'li',
	          null,
	          'Solid API Integration track record'
	        ),
	        React.createElement(
	          'li',
	          null,
	          'Passed the Advanced Nativesync Consulting & Management program'
	        )
	      ),
	      this.state.integrationRequest.consultantLevel == 'diamond' && React.createElement(
	        'ul',
	        null,
	        React.createElement(
	          'li',
	          null,
	          'At least 7 years of professional developer experience.'
	        ),
	        React.createElement(
	          'li',
	          null,
	        ...
	        React.createElement(
	          'li',
	          null,
	          'Pristine API Integration track record'
	        ),
	        React.createElement(
	          'li',
	          null,
	      ...
	      React.createElement(
	        ...
	        'Discount Code',
	        React.createElement('input', { type: 'text', value: this.state.integrationRequest.discountCode, onChange: this.handleChange.bind(this, 'discountCode') }),
	        !this.state.integrationRequest.discount && React.createElement(
	          'button',
	          { className: 'pt-button pt-intent-primary', onClick: this.checkDiscountCode },
	          'Redeem Code'
	        ),
	        this.state.integrationRequest.discount && React.createElement(
	          'span',
	          { className: 'pt-button pt-intent-success' },
	          this.state.integrationRequest.discount * 100,
	          '% Discount Redeemed'
	        )
	      ),
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              'td',
	              null,
	              hoursPerExistingService,
	              ' hours per app'
	            ),
	            React.createElement(
	              'td',
	              null,
	              existingServicesCost
	            )
	          ),
	          React.createElement(
	            'tr',
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              'td',
	              null,
	              this.state.integrationRequest.discountCode
	            ),
	            React.createElement(
	              'td',
	              null,
	              '-',
	              redeemedDiscount * 100,
	              '%'
	            )
	          ),
	          React.createElement(
	      ...
	      React.createElement(
	        'label',
	        { className: 'pt-label' },
	        React.createElement('textarea', { className: 'pt-input pt-fill', value: this.state.integrationRequest.notes, onChange: this.handleChange.bind(this, 'notes') })
	      ),
	      React.createElement('hr', null),
	      React.createElement(
	        'button',
	        { className: 'pt-button', onClick: this.handleSubmit },
	        'Submit Request'
	      )
	    );
	  }
