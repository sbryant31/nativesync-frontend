...
// based on https://github.com/thomas4019/json-schema-editor/blob/master/src/index.jsx
// there was some serious hacking required to get the change handlers not to infinite loop
// i ended up calling create element when the component will mount and not putting it
...
module.exports = React.createClass({
  getDefaultProps: function() {
    return {
      definition: {},
      onChange: function(definition) {console.log('service def change', definition)},
    }
  },
  componentWillMount: function() {
    this.element = React.createElement(SchemaObject,
			{data: this.props.definition, onChange: this.props.onChange}
		);
  },
  render() {
    var self = this;
