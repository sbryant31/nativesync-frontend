...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({
	  ...
	  getDefaultProps: function getDefaultProps() {
	    return {
	      ...
	      onChange: function onChange(organization) {
	        console.log('change organization', organization);
	      }
	    };
	  },
	  handleChange: function handleChange(selection) {
	  ...
	  componentDidMount: function componentDidMount() {
	    ...
	    var self = this;
	    return actions.getOrganizations().then(function (result) {
	      var organizations = result.organizations;
	      self.setState({ organizations: _.indexBy(organizations, 'id') });
	      var organizationOptions = _.map(organizations, function (organization) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var lodash = __webpack_require__(5);
	var Select = __webpack_require__(3);
	var TriggerInfo = __webpack_require__(200);
	var IntegrationInstanceInputEditor = __webpack_require__(627);
	var TextInputField = __webpack_require__(8);
	var OrganizationSelect = __webpack_require__(201);
	...
	module.exports = React.createClass({
	  ...
	  handleOrganizationChange: function handleOrganizationChange(organization) {
	    this.setState({ organization: organization });
	    this.getOrganizationAuths();
	  },
	  getOrganizationAuths: function getOrganizationAuths() {
	    var self = this;
	    var serviceAuthIDs = _.pluck(this.state.serviceAuths, 'id');
	    var organization = this.state.organization;
	    actions.getOrganizationAuths(this.state.organization.id, serviceAuthIDs).then(function (result) {
	      ...
	      try {
	        for (var _iterator = serviceAuthIDs[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	          var serviceAuthId = _step.value;
	  ...
	  componentDidMount: function componentDidMount() {
	    ...
	    if (self.props.integrationId && (!self.props.id || isNaN(self.props.id))) {
	      ...
	      actions.getIntegrationById(self.props.integrationId, false).then(function (result) {
	      ...
	      actions.getIntegrationInstanceById(self.props.id).then(function (result) {
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        this.state.integrationInstance.title
	      ),
	      React.createElement(
	        _core.Tabs,
	        null,
	        ...
	        React.createElement(
	          ...
	          React.createElement(TextInputField, { label: 'Title', value: this.state.integrationInstance.title, onChange: self.handleChange.bind(self, 'title') }),
	          React.createElement(OrganizationSelect, { organization: self.state.organization, onChange: this.handleOrganizationChange.bind(this) }),
	          React.createElement(TriggerInfo, { value: this.state.integrationInstance.scheduling_info, onChange: this.handleChange.bind(this, 'scheduling_info') })
	        ),
	        React.createElement(
	          _core.TabPanel,
	          null,
	          ...
	          React.createElement(OrganizationAuthForm, { organizationAuths: this.state.organizationAuths, organization: this.state.organization, services: this.state.services, serviceAuths: this.state.serviceAuths })
	        ),
	        React.createElement(
	          _core.TabPanel,
	          null,
	          ...
	          React.createElement(IntegrationInstanceInputEditor, {
	...
	module.exports = React.createClass({
	  ...
	  getDefaultProps: function getDefaultProps() {
	    return {
	      configuration: [],
	      value: {},
	      onChange: function onChange(configuration) {
	  ...
	  render: function render() {
	    ...
	    var configurationList = lodash.map(self.props.configuration, function (configuration, index) {
	      return React.createElement(
	        'div',
	        null,
	        React.createElement(TextInputField, { label: configuration.label,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var actions = __webpack_require__(4);
	// var Navbar = require('../components/navbar');
	var IntegrationInstance = __webpack_require__(626);
	var lodash = __webpack_require__(5);
	...
	module.exports = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(IntegrationInstance, { id: this.props.params.id, integrationId: this.props.params.integrationId });
	  }
	});
