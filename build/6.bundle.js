...
/***/ function(module, exports, __webpack_require__) {
	...
	var actions = __webpack_require__(4);
	var _ = __webpack_require__(6);
	var ListView = __webpack_require__(119);
	// const MarketplaceView = require('./integration_browser/marketplace_view');
	var MarketplaceView2 = __webpack_require__(120);
	var ServiceMultiSelect = __webpack_require__(72);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactEllipsisText = __webpack_require__(153);
	...
	var circle_arrow = __webpack_require__(116);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _filler_text = __webpack_require__(616);
	  ...
	  _createClass(IntegrationDetails, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      actions.getMarketplaceIntegrationById(this.props.integration_id).then(function (integration) {
	        ...
	        _this2.setState({ integration: integration.integration });
	      });
	    }
	  }, {
	    key: '_overview',
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'p',
	            null,
	            this.state.integration.description || _filler_text.filler_text_short
	          )
	        ),
	        _react2.default.createElement(
	          'div',
	          ...
	          _react2.default.createElement(
	            'p',
	            null,
	            this.state.integration.how_it_works || _filler_text.filler_text_long
	          )
	        ),
	        _react2.default.createElement(
	          'div',
	          ...
	          _react2.default.createElement(
	            'p',
	            null,
	            this.state.integration.requirements || _filler_text.filler_text_long
	          )
	        )
	      );
	    }
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'p',
	            null,
	            _filler_text.filler_text_par1
	          ),
	          _react2.default.createElement(
	            'p',
	            null,
	            _filler_text.filler_text_par2
	          ),
	          _react2.default.createElement(
	            'p',
	            null,
	            _filler_text.filler_text_par3
	          )
	        )
	      );
	    }
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(_core.Button, { className: 'pt-intent-primary pt-large', text: 'Buy Now' }),
	              _react2.default.createElement(
	                'h4',
	                { className: 'pricing' },
	                '$' + this.state.integration.pricing.upfront + ' + ' + ('$' + this.state.integration.pricing.monthly + '/month')
	              ),
	              this._likes()
	            )
	          )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _integration_details = __webpack_require__(617);
	...
	var IntegrationBrowser = __webpack_require__(118);
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(IntegrationBrowser, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".integration-request {\n  text-align: right;\n}\n\n.MarketplaceView .integration {\n  background-color: #f9f9f9;\n  margin-bottom: 20px;\n  height: 250px;\n  position: relative;\n}\n\n.MarketplaceView .integration .services-icons {\n  margin-bottom: 10px;\n}\n\n.MarketplaceView .integration .services-icons .service img {\n  height: 40px;\n}\n\n.MarketplaceView .integration .services-icons .service img.circle_arrow {\n  height: 20px;\n  margin: 0px 12px 10px 12px;\n  opacity: 0.15;\n}\n\n.MarketplaceView .integration .author {\n  position: absolute;\n  bottom: 16px;\n  color: #AAA;\n}\n\n.MarketplaceView .integration .pricing {\n  position: absolute;\n  bottom: 10px;\n  right: 10px;\n  background-color: #E0E0E0;\n  padding: 8px 12px;\n  border-radius: 20px;\n  color: #666;\n  font-size: 0.9em;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */", "", {"version":3,"sources":["/./app/components/integration_browser/integration_browser.scss","/./app/components/integration_browser/integration_browser.scss"],"names":[],"mappings":"AAAA;EACE,kBAAiB;CCClB;;AAED;EDEI,0BAAmB;EACnB,oBAAa;EACb,cAAU;EALd,mBACE;CCKD;;AAED;EACE,oBDRA;CCSD;;AAED;EDZA,aAAA;CCcC;;AAED;EDhBA,aAAA;ECkBE,2BDSsB;ECRtB,cDSgB;CCRjB;;AAED;EACE,mBDSmB;ECRnB,aDSe;ECRf,YDSa;CCRd;;AAED;EACE,mBAAmB;EACnB,aAAa;EACb,YAAY;EACZ,0BAA0B;EAC1B,kBAAkB;EAClB,oBAAoB;EACpB,YAAY;EACZ,iBAAiB;CAClB;;AAED,igFAAigF","file":"integration_browser.scss","sourcesContent":[".integration-request {\n  text-align: right;\n}\n.MarketplaceView {\n  .integration {\n    background-color: #f9f9f9;\n    margin-bottom: 20px;\n    height: 250px;\n    position: relative;\n    .services-icons {\n      margin-bottom: 10px;\n      .service {\n        img { height: 40px; }\n        img.circle_arrow {\n          height:20px;\n          margin: 0px 12px 10px 12px;\n          opacity: 0.15;\n        }\n      }\n    }\n    .title {\n    }\n    .description {\n    }\n    .author {\n      position: absolute;\n      bottom: 16px;\n      color: #AAA;\n    }\n    .pricing {\n      position: absolute;\n      bottom: 10px;\n      right: 10px;\n      background-color: #E0E0E0;\n      padding: 8px 12px;\n      border-radius: 20px;\n      color: #666;\n      font-size: 0.9em;\n    }\n  }\n}\n",".integration-request {\n  text-align: right;\n}\n\n.MarketplaceView .integration {\n  background-color: #f9f9f9;\n  margin-bottom: 20px;\n  height: 250px;\n  position: relative;\n}\n\n.MarketplaceView .integration .services-icons {\n  margin-bottom: 10px;\n}\n\n.MarketplaceView .integration .services-icons .service img {\n  height: 40px;\n}\n\n.MarketplaceView .integration .services-icons .service img.circle_arrow {\n  height: 20px;\n  margin: 0px 12px 10px 12px;\n  opacity: 0.15;\n}\n\n.MarketplaceView .integration .author {\n  position: absolute;\n  bottom: 16px;\n  color: #AAA;\n}\n\n.MarketplaceView .integration .pricing {\n  position: absolute;\n  bottom: 10px;\n  right: 10px;\n  background-color: #E0E0E0;\n  padding: 8px 12px;\n  border-radius: 20px;\n  color: #666;\n  font-size: 0.9em;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */"],"sourceRoot":"webpack://"}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".IntegrationDetails {\n  width: 1080px;\n  margin: 0px auto;\n}\n\n.IntegrationDetails .heading {\n  margin-bottom: 15px;\n}\n\n.IntegrationDetails .heading .title {\n  margin: 10px 0px;\n}\n\n.IntegrationDetails .subheading {\n  line-height: 10px;\n}\n\n.IntegrationDetails .details-col-1 .services-icons {\n  background-color: #FFF;\n  box-shadow: 0px 0px 8px #aaa;\n  border-radius: 5px;\n  padding: 10px;\n  text-align: center;\n  margin-bottom: 30px;\n  padding: 40px 0px;\n}\n\n.IntegrationDetails .details-col-1 .services-icons img {\n  height: 100px;\n}\n\n.IntegrationDetails .details-col-1 .services-icons img.circle_arrow {\n  opacity: 0.15;\n  height: 50px;\n  margin: 0px 15px 25px 15px;\n}\n\n.IntegrationDetails .details-col-1 .what-you-need {\n  margin-bottom: 30px;\n}\n\n.IntegrationDetails .details-col-2 button {\n  padding: 5px 30px;\n  width: 100%;\n}\n\n.IntegrationDetails .details-col-2 .pricing {\n  font-size: 20px;\n  text-align: center;\n  padding: 20px 0px;\n  margin: 0px;\n}\n\n.IntegrationDetails .details-col-2 .likes {\n  padding: 15px 15px;\n  border: 1px solid #DDD;\n  border-radius: 6px;\n}\n\n.IntegrationDetails .details-col-2 .likes .fa {\n  margin-right: 5px;\n}\n\n.IntegrationDetails .details-col-2 .likes .fa.fa-heart-o {\n  opacity: 0.5;\n}\n\n.IntegrationDetails .details-col-2 .likes .total_likes_indicator {\n  float: right;\n  color: #9B9B9B;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */", "", {"version":3,"sources":["/./app/components/integration_details/integration_details.scss","/./app/components/integration_details/integration_details.scss"],"names":[],"mappings":"AAAA;EACE,cAAa;EACb,iBAAgB;CCCjB;;AAED;EACE,oBDF2B;CCG5B;;AAED;EACE,iBDII;CCHL;;AAED;EACE,kBDIgB;CCHjB;;AAED;EACE,uBDG4B;ECF5B,6BDTA;ECUA,mBDGmB;ECFnB,cDGc;ECFd,mBDGc;EAzBhB,oBAUE;ECcA,kBDQmB;CCPpB;;AAED;ED3BA,cAAA;CC6BC;;AAED;EACE,cDce;EA9CjB,aAAA;ECkCE,2BDesB;CCdvB;;AAED;EACE,oBDeoB;CCdrB;;AAED;EACE,kBDiBkB;EChBlB,YDiBa;CChBd;;AAED;EACE,gBAAgB;EAChB,mBAAmB;EACnB,kBAAkB;EAClB,YAAY;CACb;;AAED;EACE,mBAAmB;EACnB,uBAAuB;EACvB,mBAAmB;CACpB;;AAED;EACE,kBAAkB;CACnB;;AAED;EACE,aAAa;CACd;;AAED;EACE,aAAa;EACb,eAAe;CAChB;;AAED,i8HAAi8H","file":"integration_details.scss","sourcesContent":[".IntegrationDetails {\n  width: 1080px;\n  margin: 0px auto;\n  .heading {\n    .title { margin: 10px 0px; }\n    margin-bottom: 15px;\n  }\n  .subheading {\n    line-height: 10px;\n  }\n  .details-col-1 {\n    // border: 1px dashed #F00;\n    // padding: 0px 15px;\n    .services-icons {\n      background-color: #FFF;\n      box-shadow: 0px 0px 8px #aaa;\n      border-radius: 5px;\n      padding: 10px;\n      text-align: center;\n      margin-bottom: 30px;\n      padding: 40px 0px;\n      img { height: 100px; }\n      img.circle_arrow {\n        opacity: 0.15;\n        height: 50px;\n        margin: 0px 15px 25px 15px;\n      }\n    }\n    .developer {\n\n    }\n    .what-you-need {\n      margin-bottom: 30px;\n    }\n  }\n  .details-col-2 {\n    // border: 1px dashed #F00;\n    // padding: 0px 15px;\n    button {\n      padding: 5px 30px;\n      width: 100%;\n    }\n    .pricing {\n      font-size: 20px;\n      text-align: center;\n      padding: 20px 0px;\n      margin: 0px;\n    }\n    .likes {\n      padding: 15px 15px;\n      border: 1px solid #DDD;\n      border-radius: 6px;\n      .fa {\n        margin-right: 5px;\n        &.fa-heart-o {\n          opacity: 0.5;\n        }\n      }\n      .total_likes_indicator {\n        float: right;\n        color: #9B9B9B;\n        .howmany {\n\n        }\n      }\n    }\n  }\n}\n",".IntegrationDetails {\n  width: 1080px;\n  margin: 0px auto;\n}\n\n.IntegrationDetails .heading {\n  margin-bottom: 15px;\n}\n\n.IntegrationDetails .heading .title {\n  margin: 10px 0px;\n}\n\n.IntegrationDetails .subheading {\n  line-height: 10px;\n}\n\n.IntegrationDetails .details-col-1 .services-icons {\n  background-color: #FFF;\n  box-shadow: 0px 0px 8px #aaa;\n  border-radius: 5px;\n  padding: 10px;\n  text-align: center;\n  margin-bottom: 30px;\n  padding: 40px 0px;\n}\n\n.IntegrationDetails .details-col-1 .services-icons img {\n  height: 100px;\n}\n\n.IntegrationDetails .details-col-1 .services-icons img.circle_arrow {\n  opacity: 0.15;\n  height: 50px;\n  margin: 0px 15px 25px 15px;\n}\n\n.IntegrationDetails .details-col-1 .what-you-need {\n  margin-bottom: 30px;\n}\n\n.IntegrationDetails .details-col-2 button {\n  padding: 5px 30px;\n  width: 100%;\n}\n\n.IntegrationDetails .details-col-2 .pricing {\n  font-size: 20px;\n  text-align: center;\n  padding: 20px 0px;\n  margin: 0px;\n}\n\n.IntegrationDetails .details-col-2 .likes {\n  padding: 15px 15px;\n  border: 1px solid #DDD;\n  border-radius: 6px;\n}\n\n.IntegrationDetails .details-col-2 .likes .fa {\n  margin-right: 5px;\n}\n\n.IntegrationDetails .details-col-2 .likes .fa.fa-heart-o {\n  opacity: 0.5;\n}\n\n.IntegrationDetails .details-col-2 .likes .total_likes_indicator {\n  float: right;\n  color: #9B9B9B;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */"],"sourceRoot":"webpack://"}]);
